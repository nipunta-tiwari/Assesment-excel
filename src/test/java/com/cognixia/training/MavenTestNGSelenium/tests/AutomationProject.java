...
import com.cognixia.training.MavenTestNGSelenium.common.AutoBAse;

public class AutomationProject extends AutoBAse{
	...
	public static void captureImages() throws IOException {
		...
		takeScreenshot();
		FileUtils.copyFile(f,new File("C:\\cognixiaassessment\\MavenTestNGSelenium\\ScreenshotAuto\\img1.jpg"));
		driver.findElement(By.xpath("//a[@title= 'Close']")).click();

		// Image 2
		driver.findElement(By.xpath("//img[@id='thumb_2']")).click();
		takeScreenshot();
		FileUtils.copyFile(f,new File("C:\\cognixiaassessment\\MavenTestNGSelenium\\ScreenshotAuto\\img2.jpg"));
		driver.findElement(By.xpath("//a[@title= 'Close']")).click();

		// Image 3
		driver.findElement(By.xpath("//img[@id='thumb_3']")).click();
		takeScreenshot();
		FileUtils.copyFile(f,new File("C:\\cognixiaassessment\\MavenTestNGSelenium\\ScreenshotAuto\\img3.jpg"));
		driver.findElement(By.xpath("//a[@title= 'Close']")).click();
		...
		takeScreenshot();
		FileUtils.copyFile(f,new File("C:\\cognixiaassessment\\MavenTestNGSelenium\\ScreenshotAuto\\img4.jpg"));
		driver.findElement(By.xpath("//a[@title= 'Close']")).click();
